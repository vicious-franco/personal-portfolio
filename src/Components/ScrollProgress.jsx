...
const ScrollProgress = () => {
  ...
  return (
    <div
      ...
      className="cursor-pointer  hover:shadow-[1px_0px_10px_#4bd3a8ca] rounded-full ease-in-out duration-100 md:shadow-[1px_0px_4px_#4bd3a8ca] fixed w-[3.5em] h-[3.5em] md:w-[4em] md:h-[4em]  md:bottom-12 bottom-8 right-8 md:right-20 flex items-center justify-center z-20"
    >
